...
class Product(db.Model):
    ...
    category = db.Column(db.String(50))  # Masonry/Scaffolding/Plumbing/Painting/Tile Works/Steels/Woods & Boards/Glass & Aluminum/Miscellaneous/Safety/Tools/Pats Products/Raw Materials
...
def compare():
    ...
    categories = ['Masonry', 'Scaffolding', 'Plumbing', 'Painting', 'Tile Works', 'Steels', 'Woods & Boards', 'Glass & Aluminum', 'Miscellaneous', 'Safety', 'Tools', 'Pats Products', 'Raw Materials']
...
def add_product():
    ...
    categories = ['Masonry', 'Scaffolding', 'Plumbing', 'Painting', 'Tile Works', 'Steels', 'Woods & Boards', 'Glass & Aluminum', 'Miscellaneous', 'Safety', 'Tools', 'Pats Products', 'Raw Materials']
    units = ['bag', 'liter', 'sqm', 'pcs', 'roll', 'set', 'kg', 'meter', 'pair', 'box', 'gallon', 'sheet', 'length']
...
@app.route('/api/products/edit/<int:id>', methods=['POST'])
...
@app.route('/api/products/delete/<int:id>', methods=['POST'])
